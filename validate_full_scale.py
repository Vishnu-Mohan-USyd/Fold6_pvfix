#!/usr/bin/env python
"""validate_full_scale.py — Multi-HC Phase B measuring BOTH F>R and omission response.

Combines the multi-HC F>R weight-based metric from validate_multihc_tf05.py
with the omission response (OMR) conductance-based metric from the Phase B
omission protocol (Gavornik & Bear 2014).
